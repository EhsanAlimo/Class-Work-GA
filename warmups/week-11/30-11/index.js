...
// console.log(realDigits); ///to access all the digits of a number
  ...
  isHappy: function (n) {
    ...
    while (true) {
      ...
      if (n === 1) {
        ...
        //forcing this.findSquareSum(n) to equal n. if the number exists in the array (not equal -1) then return false
        return false;
      }
    }
  },
